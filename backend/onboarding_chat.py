...
def _build_onboarding_system_prompt(user, phase_idx, question_idx, language):
    ...
    return (
        ...
        f"7. VARIETY: Never repeat the same phrases. Avoid 'Spill the chai!', 'Tell me everything', 'Go on...'. "
        f"Use variety like: 'Batao, kya hua?', 'Aur?', 'Sach mein?', 'Haha nice', 'Samajh gaya/gayi', 'Phir?'\n\n"
        f"{previous_context}\n"
